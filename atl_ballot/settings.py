...
INSTALLED_APPS = [
    ...
    "megaverse.apps.MegaverseConfig",
]
...
# Email settings
# -------------------------------------------------------------------
# Local development stays on console email.
# Production/Render uses SMTP when EMAIL_HOST is provided.
...
DEFAULT_FROM_EMAIL = os.environ.get(
    "DEFAULT_FROM_EMAIL",
    "ATL’s Hottest Awards <noreply@atlshottestawards.com>",
)
